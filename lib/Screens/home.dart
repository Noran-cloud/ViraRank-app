...
import 'package:ieee/Screens/analyzeWebsite.dart';
import 'package:ieee/Screens/select_platform.dart';
    ...
    return Scaffold(
      ...
      body: Column( 
        children: [
          ...
          GestureDetector(
            onTap: () {
              Navigator.push(context, MaterialPageRoute(builder: (context)=> Analyzewebsite()));
            },
            child: SizedBox(
              height: 70,
              width: 270,
